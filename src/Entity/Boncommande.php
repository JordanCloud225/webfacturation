...
#[ApiResource(
    ...
    normalizationContext: ['groups' => ['boncommande:read']],
    denormalizationContext: ['groups' => ['boncommande:write']]
)]
class Boncommande extends EntityBase
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['boncommande:read'])]
    private ?int $id = null;
    
  
    #[ORM\Column(nullable: true)]
    #[Groups(['boncommande:read', 'boncommande:write'])]
    ...
    public function addDetailcommande(Detailcommande $boncommande): static
    {
        if (!$this->boncommandes->contains($boncommande)) {
            $this->boncommandes->add($boncommande);
            $boncommande->setBoncommande($this);
        }

        return $this;
    }

    public function removeDetailcommande(Detailcommande $boncommande): static
    {
        if ($this->boncommandes->removeElement($boncommande)) {
            // set the owning side to null (unless already changed)
            if ($boncommande->getBoncommande() === $this) {
                $boncommande->setBoncommande(null);
            }
        }
